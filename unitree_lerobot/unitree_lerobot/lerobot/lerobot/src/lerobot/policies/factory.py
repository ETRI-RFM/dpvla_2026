...
#
from lerobot.policies.dpact_dino_v3_variance.configuration_dpact_dino_v3_variance import DPACTDINOv3VarianceConfig
#
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    #
    elif policy_type == "dpact_dino_v3_variance":
        return DPACTDINOv3VarianceConfig(**kwargs)
    #
    else:
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    #
    elif isinstance(policy_cfg, DPACTDINOv3VarianceConfig):
        from lerobot.policies.dpact_dino_v3_variance.processor_dpact_dino_v3_variance import make_dpact_dino_v3_variance_pre_post_processors

        processors = make_dpact_dino_v3_variance_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
    #
