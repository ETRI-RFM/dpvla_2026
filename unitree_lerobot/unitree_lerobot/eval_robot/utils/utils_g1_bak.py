...
class DualProcess_VLA:
    def __init__(self, system1_cfg_path, system2_model_path, system1_hz=30.0, system2_hz=2.0):
    ...
    def extract_latent(self, obs_dict):
        ...
        with open("/home/goodman/g1_eval_protocol/language_instruction.txt", "r") as f:
            prompt = f.read()
