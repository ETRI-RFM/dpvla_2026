    ...
    def receive_process(self):
        ...
        try:
            while self.running:
                ...
                # =====   sjh =====
                #print("first2", message[:2], "after12", message[12:14], "len", len(message))
                # ======================
                ...
                if self._enable_performance_eval:
                    ...
                    jpg_bytes = message
                    ### sjh ✅ 최소수정: 앞에 12바이트 헤더가 붙어오면 제거
                    if len(jpg_bytes) > 12 and jpg_bytes[:2] != b"\xff\xd8" and jpg_bytes[12:14] == b"\xff\xd8":
                        jpg_bytes = jpg_bytes[12:]
                    ###
                # Decode image
